!function(e, t) {
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t, n, h, m, v, y) {
            ...
            }, x = t + " Iterator", S = "values" == m, E = !1, C = e.prototype, N = C[f] || C["@@iterator"] || m && C[m], O = N || _(m), k = m ? S ? _("entries") : O : void 0, M = "Array" == t ? C.entries || N : N;
            if (M && (w = l(M.call(new e))) !== Object.prototype && w.next && (c(w, x, !0),
            r || "function" == typeof w[f] || a(w, f, d)),
            S && N && "values" !== N.name && (E = !0,
            O = function() {
                return N.call(this)
            }
            ),
                ...
                function b(e) {
                    ...
                    for (var o = 0; o < e.length; o++) {
                        ...
                        if ("function" != typeof i)
                            return c("Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + N(i) + " at index " + o + "."),
                            r
                    }
                    return d(n)
                }
...
*/
    ...
    , function(e, t, n) {
        !function() {
            ...
            function b(e, t) {
                var n = e._component;
                n ? k(n) : (null != e.__preactattr_ && e.__preactattr_.ref && e.__preactattr_.ref(null),
            ...
            function C(e, t, n, r, o) {
                ...
                e.props = t,
                e.__x = !1,
                0 !== n && (1 !== n && !1 === T.syncComponentUpdates && e.base ? i(e) : N(e, 1, o)),
                e.__r && e.__r(e))
            }
            function N(e, t, n, o) {
                if (!e.__x) {
            ...
            function k(e) {
                ...
                e.base = null;
                var n = e._component;
                n ? k(n) : t && (t.__preactattr_ && t.__preactattr_.ref && t.__preactattr_.ref(null),
                e.__b = t,
                f(t),
                x(e),
                w(t)),
 ...
 */
            ...
            function t(e) {
                ...
                n.getCommentsV3 = function(e) {
                    ...
                    return n.getIssue().then(function(e) {
                        if (e)
                            return N.axiosGithub.get(e.comments_url, {
                                headers: {
                ...
                n.handlePopup = function(e) {
                    ...
                    var t = !n.state.isPopupVisible
                      , r = function e(t) {
                        (0,
                        N.hasClassInParent)(t.target, "gt-user", "gt-popup") || (window.document.removeEventListener("click", e),
                        n.setState({
                            isPopupVisible: !1
                        }))
                    };
                ...
                if (o.code) {
                    ...
                    N.queryStringify)(o) + window.location.hash;
                    ...
                    N.axiosJSON.post(n.options.proxy, {
                        ...
                        n.setState({
                            isOccurError: !0,
                            errorMsg: (0,
                            N.formatErrorMsg)(new Error("no access token"))
                        }))
                    }).catch(function(e) {
                        console.log("err: ", e),
                        n.setState({
            ...
            d.default)(t, [{
                ...
                value: function() {
                    ...
                    return N.axiosGithub.post("/repos/" + n + "/" + r + "/issues", {
                        ...
                        labels: u.concat(a),
                        body: i || s + " \n\n " + ((0,
                        N.getMetaContent)("description") || (0,
                        N.getMetaContent)("description", "og:description") || "")
                    }, {
                        headers: {
                            Authorization: "token " + this.accessToken
                        }
    ...
    , function(e, t, n) {
        "use strict";
        var r, o, i, a, u = n(21), s = n(1), c = n(13), l = n(41), f = n(4), p = n(10), d = n(24), h = n(110), m = n(111), v = n(59), y = n(60).set, g = n(113)(), b = n(43), w = n(61), _ = n(114), x = n(62), S = s.TypeError, E = s.process, C = E && E.versions, N = C && C.v8 || "", O = s.Promise, k = "process" == l(E), M = function() {}, P = o = b.f, T = !!function() {
            try {
                var e = O.resolve(1)
    ...
    , function(e, t, n) {
        ...
        : function(e) {
          ...
          , q = function(e, t, n) {
            ...
            t = x(t, !0),
            g(n),
            o(B, t) ? (n.enumerable ? (o(e, L) && e[L][t] && (e[L][t] = !1),
            n = E(n, {
                enumerable: S(0, !1)
            })) : (o(e, L) || T(e, L, S(1, {})),
            e[L][t] = !0),
          ...
          , te = function(e) {
            for (var t, n = e === H, r = A(n ? z : _(e)), i = [], a = 0; r.length > a; )
